...
import { withStyles, Divider, TextField, InputAdornment } from '@material-ui/core';
...
const Slot = ({
  ...
  classes: { slot, controls, board, divider, topDivider, middleDivider, bottomDivider, textFieldSmall, underline, darkLabel, adornment }
}) => {
